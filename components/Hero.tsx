...
const Hero: FC = () => {
  return (
    <div
      ...
      <p className="lg:text-3xl font-extrabold text-center text-lg">Church Is Not Just The Physical Building<br /> But It Is The Ground And Pillar Of Truth. <br /><span className="text-base"> 1 Timothy 3:15</span></p>
