    ...
    <section className="mt-24" id="about-us">
      ...
      <div className="flex justify-around lg:flex-row items-center flex-col">
        ...
        <Div
          ...
          <h1 className="text-text font-bold tracking-widest text-2xl before:content-[''] before:absolute before:w-16 before:h-1 before:rounded-full  before:bg-text  before:mt-8  before:origin-left before:transition-[transform] before:duration-300 hover:before:scale-x-125 w-fit cursor-pointer" ref={imageContainerEl}>About US</h1>
        <div>
          <h2 className="text-text font-semibold tracking-widest text-xl">Why We Exist</h2>
