    ...
    <svg {...props} width="120px" height="120px" viewBox="0 0 120 120" id="Layer_1" version="1.1"  xmlns="http://www.w3.org/2000/svg">
      <g>
        ...
        <g style={{ opacity: 0.15 }}>
          ...
          <path d="M65,98.9l-4.4-2.6c-1.5-0.9-3.2-1.1-4.9-0.7l-0.6,0.1c0.9,0.1,1.7,0.4,2.5,0.8l4.4,2.6c1.7,1,3.6,1.1,5.4,0.5    C66.6,99.6,65.8,99.4,65,98.9z" /></g>
        <polyline fill="#00D566" points="44,53.6 56.5,67.9 82.1,47.3  " />
        <path fill="#ffffff" d="M53.5,75.3c-1.4,0-2.8-0.6-3.8-1.7L37.2,59.3c-1.8-2.1-1.6-5.2,0.4-7.1c2.1-1.8,5.2-1.6,7.1,0.4l9.4,10.7   l21.9-17.6c2.1-1.7,5.3-1.4,7,0.8c1.7,2.2,1.4,5.3-0.8,7L56.6,74.2C55.7,74.9,54.6,75.3,53.5,75.3z" /></g>
    </svg>
  );
}
