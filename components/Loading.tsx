  ...
  return (
    ...
    >
      <div className="flex flex-col rounded-full w-36 h-36 justify-between animate-spin">
        <div className="w-6 h-6 rounded-full bg-curves relative  self-center" />

        <div className="flex justify-between">
          <div className="w-6 h-6 rounded-full bg-curves relative self-start" />
          <div className="w-6 h-6 rounded-full bg-curves relative self-end" />
        </div>
        <div className="w-6 h-6 rounded-full bg-curves relative self-center" />
      </div>
    </section>
