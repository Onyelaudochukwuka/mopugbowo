...
const Loading: FC<ILoadingProps> = ({toggle}) => {
  return (
  <section className={`${toggle ? `translate-x-0` : `-translate-x-full`} transition-transform duration-500 ease-in flex bg-black/40 fixed inset-0 w-full h-full z-50 items-center justify-center`}>
