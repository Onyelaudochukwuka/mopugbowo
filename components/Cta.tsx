...
const Cta: FC = () => {
  ...
  return (
    <div className="mx-auto mt-24 w-11/12 p-3 flex flex-col gap-4">
      <h3 className="text-2xl text-text font-bold lg:w-1/3 tracking-wider">
        Stay up-to-date with Our programmes and Event
      </h3>
      <form onSubmit={handleSubmit} className="flex justify-between mt-6 lg:flex-row flex-col gap-6">
        <label className="lg:w-3/4 relative block w-full" htmlFor="cta-email">
          ...
          <input
            type="url"
            id="cta-email"
            className="block transition-all duration-500 ease-in bg-transparent w-full py-4 pl-20 pr-3 shadow-sm outline-none ring-2 focus:ring-curves ring-primaryLight ring-offset-primaryLight ring-offset-1 focus:ring-offset-curves/30 h-[auto] align-middle my-auto rounded-md text-white placeholder:text-white placeholder:text-lg text-lg placeholder:font-bold font-bold placeholder:align-middle placeholder:my-auto self-stretch"
        ...
        <button
          type="submit"
          className="text-primaryLight font-bold bg-light px-8 rounded-md py-4 text-center"
        >
          Submit
        </button>
      </form>
